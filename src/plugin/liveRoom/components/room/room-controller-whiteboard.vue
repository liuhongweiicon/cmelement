      ...
      <div class="controller" v-if="role === 1 || classScene !== 2">
        ...
        >
          ...
          >
            ...
            <div
              ...
              v-html="require('../../../static/img/roomIcon/but_del.svg').default"
            ></div>
          </el-option>
        </el-select>
        ...
        <div v-if="roomAuth.share && !activeViewIsExcel" class="page-bar">
          <div
            ...
            v-html="require('../../../static/img/roomIcon/arrow_left.svg').default"
          ></div>
          <div class="pagebar-center">{{ `${currPage} / ${totalPage}` }}</div>
          <div
            @click="handlePageChange_(1)"
            :class="['page-bar-arrow', 'arrow-next', currPage === totalPage && 'disabled']"
            v-html="require('../../../static/img/roomIcon/arrow_right.svg').default"
          >
            next
          </div>
        </div>
        ...
        <div class="zoom-bar" v-if="computedViewList && computedViewList.length > 0">
          <div
            ...
            v-html="require('../../../static/img/roomIcon/top_down.svg').default"
          ></div>
          ...
          <div
            ...
            v-html="require('../../../static/img/roomIcon/top_add.svg').default"
          ></div>
        </div>
        <!-- 略缩图 -->
        <div
        ...
        >
          <span
            class="button-icon"
            v-html="require('../../../static/img/roomIcon/preview.svg').default"
          ></span>
          <span>预览</span>
        </div>
      </div>
