...
<template>
  <div class="canvas-tools" id="canvasTools">
    <ul class="tools-list">
      ...
      >
        <div v-html="require(`../../../static/img/roomIcon/${item.imgName}.svg`).default"></div>
...
import RoomWhiteboardPencil from './room-whiteboard-pencil'
...
export default {
  ...
  mounted() {
    if (this.zegoLiveRoom.$http.role == this.thisParent.liveRoomParams.ROLE_STUDENT) {
