<template>
    <div id="allStem">
        ...
        <cm-all-stem ref="allStem" :userInfo="userInfo" :paperDetails="paperDetails" :paperState="1"  @slideChangeEnd="slideChangeEndHnadler" @submit="submitHandler" @goBack="goBackHandler"></cm-all-stem>
